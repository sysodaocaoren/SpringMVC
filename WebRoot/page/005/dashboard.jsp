...
<head>
	...
	<link rel="stylesheet" href="<%=path%>/page/005/css/style.css" type="text/css"></link></head>
    <script type="text/javascript" src="<%=path%>/page/005/js/jquery-1.10.2.js"></script>
</head>
<body>
<div class="testing">
<header class="main">
...
<script src="<%=path%>/page/005/js/jquery.wysiwyg.js"></script>
<script src="<%=path%>/page/005/js/custom.js"></script>
<script src="<%=path%>/page/005/js/cycle.js"></script>
<script src="<%=path%>/page/005/js/jquery.checkbox.min.js"></script>
<script src="<%=path%>/page/005/js/flot.js"></script>
<script src="<%=path%>/page/005/js/flot.resize.js"></script>
<script src="<%=path%>/page/005/js/flot-time.js"></script>
<script src="<%=path%>/page/005/js/flot-pie.js"></script>
<script src="<%=path%>/page/005/js/flot-graphs.js"></script>
<script src="<%=path%>/page/005/js/cycle.js"></script>
<script src="<%=path%>/page/005/js/jquery.tablesorter.min.js"></script>
