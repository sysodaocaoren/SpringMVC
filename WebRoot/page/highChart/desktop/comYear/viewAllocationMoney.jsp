					...
					<table cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<td style="width: 120px;">到账收入</td>
								<td style="width: 120px;">分配资金</td>
							</tr>
						</thead>
					</table>
				</div>
						...
						<tbody>
							<c:forEach var="comzqs" items="${comYearZQs}" varStatus="status">
								<tr>
									...
									<td style="width: 120px;">
										<span style="width: 110px;text-align:right;" title="${comzqs.allocationMoney}" >
											<fmt:formatNumber value="${comzqs.allocationMoney}" pattern='￥#,##0.00#'/>
										</span>
									</td>
								</tr>
							</c:forEach>
								...
								<table cellspacing="0" cellpadding="0">
									<thead>
										<tr>
											...
											<td style="width: 120px;text-align:right;">
												<fmt:formatNumber value="${allallocationMoney}" pattern='#,##0.00# 亿元'/>
											</td>
										</tr>
									</thead>
								</table>
