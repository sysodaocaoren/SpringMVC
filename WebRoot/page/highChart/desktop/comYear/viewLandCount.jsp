					...
					<table cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<td style="width: 130px;">合同编号</td>
								<td style="width: 100px;">签订时间</td>
								<td style="width: 180px;">用地单位</td>
								<td style="width: 180px;">熟化主体</td>
								<td style="width: 120px;">合同金额</td>
								<td style="width: 120px;">已缴款</td>
								<td style="width: 120px;">未缴款</td>
							</tr>
						</thead>
					</table>
				</div>
						...
						<tbody>
							<c:forEach var="comzqs" items="${comYearZQs}" varStatus="status">
								<tr>
									...
									<td style="width: 130px;text-align:center;"><span style="width: 120px;" title="${comzqs.contractNum}" >${comzqs.contractNum}</span></td>
									...
									<td style="width: 180px;">
										<span style="width: 170px;text-align:center;" title="${comzqs.landUserName}" >
											${comzqs.landUserName}
										</span>
									</td>
									<td style="width: 180px;">
										<span style="width: 170px;text-align:center;" title="${comzqs.cormainName}" >
											${comzqs.cormainName}
										</span>
									</td>
									...
									<td style="width: 120px;">
										<span style="width: 110px;text-align:right;" title="${comzqs.contractMoney-comzqs.DZmoney}" >
											<fmt:formatNumber value="${comzqs.contractMoney-comzqs.DZmoney}" pattern='￥#,##0.00#'/>
										</span>
									</td>
								</tr>
							</c:forEach>
								<div class="table-head">
									<table cellspacing="0" cellpadding="0">
										<thead>
											<tr>
												<td style="width: 30px;"></td>
												<td style="width: 130px;text-align:center;">合计</td>
												...
												<td style="width: 120px;text-align:right;">
													<fmt:formatNumber value="${allContractMoney-allDZmoney}" pattern='#,##0.00# 亿元'/>
												</td>
											</tr>
										</thead>
									</table>
